  ...
  return (
    <div className="flex justify-center flex-col items-center">
      <Tabs
        ...
        radius={"full"}
        onSelectionChange={(selected) => setTabSelected(selected as string)}
      >
      ...
      >
        ...
        >
          ...
          <p className="text-sm md:text-medium">
            Hey! I’m <span className="font-oleo text-2xl"> Eric</span>, a software engineer, hailing
            from UCLA and Purdue. Currently, I’m building a cool marketing AI agent. My world
            revolves around web development, deep learning, and data science. And yes, I have an
        ...
        <div
          ...
          className={cn(
            "bg-white dark:bg-darkBg border-2 border-transparent dark:border-knight cursor-grab active:cursor-grabbing rounded-[2rem] flex justify-center items-center z-[1]",
            selectedCard[tabSelected]["animatedEmoji"] ? "opacity-100" : "opacity-50",
          )}
        >
          <AnimatedEmoji />
        </div>
        <div
          ...
          className={cn(
            ...
            selectedCard[tabSelected]["mapComponent"] ? "opacity-100" : "opacity-50",
          )}
        >
          <MapComponent />
        </div>
